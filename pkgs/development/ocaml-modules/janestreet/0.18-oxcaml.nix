...

{
  abstract_algebra = janePackage {
    ...
    meta.description = "abstract_algebra";
  ...
  async_rpc_kernel = janePackage {
    ...
    meta.description = "async_rpc_kernel";
    propagatedBuildInputs = [
      async_kernel
      bin_prot
      core
  ...
  base_bigstring = janePackage {
    ...
    meta.description = "base_bigstring";
    propagatedBuildInputs = [
      base
      int_repr
      ppx_jane
  ...
  base_internalhash_types = janePackage {
    ...
    meta.description = "base_internalhash_types";
  };
  ...
  base_quickcheck = janePackage {
    ...
    meta.description = "base_quickcheck";
    propagatedBuildInputs = [
      base
      ppx_base
      ppx_fields_conv
  ...
  bonsai_concrete = janePackage {
    ...
    meta.description = "bonsai_concrete";
    propagatedBuildInputs = [
      core
      core_kernel
      incr_map
  ...
  capitalization = janePackage {
    ...
    meta.description = "capitalization";
    propagatedBuildInputs = [
      base
      ppx_base
    ];
  ...
  core_extended = janePackage {
    ...
    meta.description = "core_extended";
    propagatedBuildInputs = [
      bin_prot
      core
      core_unix
  ...
  expect_test_helpers_base = janePackage {
    ...
    meta.description = "expect_test_helpers_base";
    propagatedBuildInputs = [
      base
      base_quickcheck
      portable
  ...
  expect_test_helpers_core = janePackage {
    ...
    meta.description = "expect_test_helpers_core";
    propagatedBuildInputs = [
      core
  ...
  flexible_sexp = janePackage {
    ...
    meta.description = "flexible_sexp";
    propagatedBuildInputs = [
      basement
      core
      ppx_jane
  ...
  janestreet_lru_cache = janePackage {
    ...
    meta.description = "janestreet_lru_cache";
    propagatedBuildInputs = [
      core
      ppx_jane
    ];
  ...
  legacy_diffable = janePackage {
    ...
    meta.description = "legacy_diffable";
    propagatedBuildInputs = [
      core
      ppx_jane
      stored_reversed
  ...
  nonempty_list_type = janePackage {
    ...
    meta.description = "nonempty_list_type";
  };
  ...
  ocaml-embed-file = janePackage {
    ...
    meta.description = "ocaml-embed-file";
    propagatedBuildInputs = [
      async
      async_kernel
      async_unix
  ...
  ocaml_intrinsics = janePackage {
    ...
    meta.description = "ocaml_intrinsics";
    propagatedBuildInputs = [
      ocaml_intrinsics_kernel
      ppx_builtin
    ];
  ...
  ocaml_intrinsics_kernel = janePackage {
    ...
    meta.description = "ocaml_intrinsics_kernel";
  };
  ...
  pipe_with_writer_error = janePackage {
    ...
    meta.description = "pipe_with_writer_error";
    propagatedBuildInputs = [
      async_kernel
      core
      ppx_jane
  ...
  portable_lockfree_htbl = janePackage {
    ...
    meta.description = "portable_lockfree_htbl";
    propagatedBuildInputs = [
      base
      basement
      portable
  ...
  ppx_array_base = janePackage {
    ...
    meta.description = "ppx_array_base";
    propagatedBuildInputs = [
      ppx_helpers
      ppxlib_jane
    ];
  ...
  ppx_custom_printf = janePackage {
    ...
    meta.description = "ppx_custom_printf";
    propagatedBuildInputs = [
      base
      ppx_sexp_conv
    ];
  ...
  ppx_debug_assert = janePackage {
    ...
    meta.description = "ppx_debug_assert";
    buildInputs = [
      ppxlib
    ];
  };
  ...
  ppx_disable_unused_warnings = janePackage {
    ...
    meta.description = "ppx_disable_unused_warnings";
    buildInputs = [
      ppxlib
    ];
  };
  ...
  ppx_embed_file = janePackage {
    ...
    meta.description = "ppx_embed_file";
    propagatedBuildInputs = [
      core
      ppx_jane
    ];
  ...
  ppx_enumerate = janePackage {
    ...
    meta.description = "ppx_enumerate";
    propagatedBuildInputs = [
      basement
      ppxlib_jane
    ];
  ...
  ppx_fields_conv = janePackage {
    ...
    meta.description = "ppx_fields_conv";
    propagatedBuildInputs = [
      base
      fieldslib
      ppx_helpers
  ...
  ppx_fixed_literal = janePackage {
    ...
    meta.description = "ppx_fixed_literal";
    doCheck = false;
    propagatedBuildInputs = [
      base
    ];
  ...
  ppx_fuelproof = janePackage {
    ...
    meta.description = "ppx_fuelproof";
    propagatedBuildInputs = [
      base
      ppx_compare
      ppx_let
  ...
  ppx_globalize = janePackage {
    ...
    meta.description = "ppx_globalize";
    propagatedBuildInputs = [
      ppx_helpers
      ppxlib_jane
    ];
  ...
  ppx_ignore_instrumentation = janePackage {
    ...
    meta.description = "ppx_ignore_instrumentation";
    buildInputs = [
      ppxlib
    ];
  };
  ...
  ppx_inline_test = janePackage {
    ...
    meta.description = "ppx_inline_test";
    doCheck = false;
    propagatedBuildInputs = [
      base
      basement
  ...
  ppx_int63_literal = janePackage {
    ...
    meta.description = "ppx_int63_literal";
    propagatedBuildInputs = [
      base
    ];
    buildInputs = [
  ...
  ppx_module_timer = janePackage {
    ...
    meta.description = "ppx_module_timer";
    propagatedBuildInputs = [
      base
      ppx_base
      ppxlib_jane
  ...
  ppx_pattern_bind = janePackage {
    ...
    meta.description = "ppx_pattern_bind";
    propagatedBuildInputs = [
      base
      ppx_let
      ppxlib_jane
  ...
  ppx_sexp_conv = janePackage {
    ...
    meta.description = "ppx_sexp_conv";
    propagatedBuildInputs = [
      basement
      ppx_helpers
      ppxlib_jane
  ...
  ppx_sexp_message = janePackage {
    ...
    meta.description = "ppx_sexp_message";
    doCheck = false;
    propagatedBuildInputs = [
      base
      ppx_here
  ...
  ppx_sexp_value = janePackage {
    ...
    meta.description = "ppx_sexp_value";
    propagatedBuildInputs = [
      base
      ppx_here
      ppx_sexp_conv
  ...
  ppx_shorthand = janePackage {
    ...
    meta.description = "ppx_shorthand";
    propagatedBuildInputs = [
      ppxlib_jane
    ];
    buildInputs = [
  ...
  ppx_stable_witness = janePackage {
    ...
    meta.description = "ppx_stable_witness";
    propagatedBuildInputs = [
      base
      basement
      ppxlib_jane
  ...
  ppx_string_conv = janePackage {
    ...
    meta.description = "ppx_string_conv";
    propagatedBuildInputs = [
      base
      capitalization
      ppx_let
  ...
  ppx_typed_fields = janePackage {
    ...
    meta.description = "ppx_typed_fields";
    propagatedBuildInputs = [
      base
      ppx_base
      ppx_compare
  ...
  ppx_typerep_conv = janePackage {
    ...
    meta.description = "ppx_typerep_conv";
    propagatedBuildInputs = [
      base
      ppx_helpers
      ppx_let
  ...
  ppx_variants_conv = janePackage {
    ...
    meta.description = "ppx_variants_conv";
    propagatedBuildInputs = [
      base
      ppxlib_jane
      variantslib
  ...
  protocol_version_header = janePackage {
    ...
    meta.description = "protocol_version_header";
    propagatedBuildInputs = [
      core
      ppx_jane
      ppx_stable_witness
  ...
  record_builder = janePackage {
    ...
    meta.description = "record_builder";
    propagatedBuildInputs = [
      base
      ppx_jane
    ];
  ...
  splittable_random = janePackage {
    ...
    meta.description = "splittable_random";
    doCheck = false;
    propagatedBuildInputs = [
      base
      capsule0
  ...
  stored_reversed = janePackage {
    ...
    meta.description = "stored_reversed";
    propagatedBuildInputs = [
      core
      ppx_jane
    ];
  ...
  textutils_kernel = janePackage {
    ...
    meta.description = "textutils_kernel";
    propagatedBuildInputs = [
      core
      ppx_jane
      uutf
  ...
  unboxed_datatypes = janePackage {
    ...
    meta.description = "unboxed_datatypes";
    propagatedBuildInputs = [
      base
      ppx_jane
    ];
  ...
  zarith_stubs_js = janePackage {
    ...
    meta.description = "zarith_stubs_js";
  };
}
